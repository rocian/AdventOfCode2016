...
diskl = 272
while len(state) < diskl:
    state = dragon(state)

dra = dragon(state)[0:diskl]
a1 = checksum(dra)
while (len(a1) % 2) == 0:
    a1 = checksum(a1)
...
print("Day 16. Solution of part 1: {}".format(a1))
print("Day 16. Solution of part 2: {}".format(a2))
