...
UUUUD
    ...
    and stay on "1"), so the first button is 1.  Starting from the previous
    button ("1"), you move right twice (to "3") and then down three times
    ...
    8.  Finally, you move up four times (stopping at "2"), then down once,
    ending with 5.
...
instructions as above, the outcome is very different:
    ...
    after five more moves, you end at 3.
